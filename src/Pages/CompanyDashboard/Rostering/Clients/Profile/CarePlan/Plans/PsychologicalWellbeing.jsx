...
import PsychologicalWellbeingDetails from "./PlansDetails/PsychologicalWellbeingDetails";
...
const PsychologicalWellbeing = ({
  ...
  const relatedTable = "PsychologicalInformation";
