...
const Info = () => {
  ...
  const carePlanSection = {
    ...
    report: "Weekly progress report: Client has shown improvement in mobility exercises. No incidents reported.",
    comment: "Carer comment: Client was cooperative today but requested more time for grooming activities."
  };
