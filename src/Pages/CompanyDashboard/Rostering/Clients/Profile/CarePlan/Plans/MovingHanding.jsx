...
import MovingHandingDetails from "./PlansDetails/MovingHandingDetails";
import {
  createClientTask,
  fetchClientTaskByClientAndRelatedTable,
} from "../../../../config/apiConfig";

const MovingHanding = ({ carePlanSection, clientData, carePlanId }) => {
  ...
  const relatedTable = "MovingHandling"; // As specified
