...
import NutritionHydrationDetails from "./PlansDetails/NutritionHydrationDetails";
import {
  createClientTask,
  fetchClientTaskByClientAndRelatedTable,
} from "../../../../config/apiConfig";

const NutritionHydration = ({ carePlanSection, clientData, carePlanId }) => {
  ...
  const relatedTable = "FoodNutritionHydration"; // As specified
