...
import RiskAssessmentDetails from "./PlansDetails/RiskAssessmentsDetails";
...
const RiskAssessments = ({ carePlanSection, carePlanId, clientData }) => {
  ...
  const relatedTable = "RiskAssessment";
