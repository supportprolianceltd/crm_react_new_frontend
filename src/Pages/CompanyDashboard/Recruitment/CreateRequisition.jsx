...
import { createRequisition, fetchStaffRequisitions } from "./ApiService";

const MAX_HEIGHT = 150;
const MAX_WORDS = 1000;

const CreateRequisition = ({ onSuccess, onClose }) => {
  ...
  }, [title, qualification, experience, knowledge, text]);
          ...
          <div className="CreateRequisition-box-Foot-2">
            ...
            <button
              ...
              style={{
                ...
                opacity: isSending || !isFormFilled ? 0.6 : 1,
                cursor: isSending || !isFormFilled ? "not-allowed" : "pointer",
              }}
