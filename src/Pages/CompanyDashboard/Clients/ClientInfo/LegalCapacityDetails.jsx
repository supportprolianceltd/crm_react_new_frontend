...
const LegalCapacityDetails = ({ onEdit, data = {} }) => {
  ...
  return (
    <div className='Info-Palt'>
      ...
      <div className='Info-Palt-Main No-Grid'>
        <div className='Info-TTb-BS-HYH'>
          ...
          <div className="JUH-PART">
            <p>Does client have the ability to make decisions related to their health & wellbeing?</p>
      ...
      <div className='Info-Palt-Main No-Grid'>
        <div className='Info-TTb-BS-HYH'>
          <h3>Recommended Summary Plan for Emergency Care and Treatment (ReSPECT)</h3>
          <div className="JUH-PART">
