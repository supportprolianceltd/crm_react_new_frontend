...
import SocialSupportDetails from "./PlansDetails/SocialSupportDetails";
...
const SocialSupport = ({ carePlanSection, carePlanId, clientData }) => {
  ...
  const relatedTable = "CultureValues";
