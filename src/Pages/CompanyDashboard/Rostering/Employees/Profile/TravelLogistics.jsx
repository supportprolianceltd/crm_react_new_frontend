...
import "../../css/TravelLogistics.css";
...
export default function TravelLogistics({ employeesData }) {
  ...
  // const fullName = `${employeesData.firstName || ""} ${
  //   employeesData.lastName || "N/A"
  // }`.trim();

  return (
    <div className="main-travel-logistics">
      <div className="header-travel-logistics">
        {/* <h2>{fullName} Travel & Logistics</h2> */}
        <h2>Sam Tally's Travel & Logistics</h2>
      </div>
