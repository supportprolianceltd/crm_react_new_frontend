...
import { createCarePlan } from "../../../../../Clients/config/apiService";
import "../styles/CreateCarePlan.css";
import CarePlanProfileCard from "./CarePlanProfileCard";
import AdministrativeBodyMapStep from "../../../../../Clients/CarePlan/steps/AdministrativeBodyMapStep";
import MovingHandlingStep from "../../../../../Clients/CarePlan/steps/MovingHandlingStep";
import CareRequirementsStep from "../../../../../Clients/CarePlan/steps/CareRequirementsStep";
import LegalRequirementsStep from "../../../../../Clients/CarePlan/steps/LegalRequirementsStep";
import { convertToISO, formatToYYYYMMDD } from "../../../../../../../utils/helpers";
// Helper to convert a date (YYYY-MM-DD or any parsable date) to ISO at 08:00 UTC
const toIsoAt08UTC = (dateString) => {
  if (!dateString) return null;
  try {
    // Try parsing directly
    let d = new Date(dateString);
    if (isNaN(d.getTime())) {
      // If parsing failed, assume date-only in YYYY-MM-DD
      d = new Date(`${dateString}T00:00:00Z`);
    }

    // Build a UTC date at 08:00 on the same calendar date (UTC)
    const y = d.getUTCFullYear();
    const m = d.getUTCMonth();
    const day = d.getUTCDate();
    const dt = new Date(Date.UTC(y, m, day, 8, 0, 0));
...
import HealthNeedsRiskAssessmentStep from "../../../../../Clients/CarePlan/steps/HealthNeedsRiskAssessmentStep";
import CareEssentialsActivityPlanStep from "../../../../../Clients/CarePlan/steps/CareEssentialsActivityPlanStep";
import MedicalInformationStep from "../../../../../Clients/CarePlan/steps/MedicalInformationStep";
import PsychologicalInformationStep from "../../../../../Clients/CarePlan/steps/PsychologicalInformationStep";
import FoodNutritionHydrationStep from "../../../../../Clients/CarePlan/steps/FoodNutritionHydrationStep";
import HistoryRoutinePreferencesStep from "../../../../../Clients/CarePlan/steps/HistoryRoutinePreferencesStep";
import CultureValuesStep from "../../../../../Clients/CarePlan/steps/CultureValuesStep";
    ...
    (data) => {
      try {
        ...
        try {
          ...
          console.log("Saved form data without previews to localStorage");
        } catch (secondError) {
        ...
        const payload = {
          ...
          bodyMap: {
            ...
            carePlanReviewDate: formData.care_plan_review_date
              ? formatToYYYYMMDD(new Date(formData.care_plan_review_date))
              : null,
            ...
            dateFirstObserved: toIsoAt08UTC(formData.wound_date_observed) || null,
          ...
          careRequirements: {
            careType: (formData.care_type || [])[0] || "Personal Care",
