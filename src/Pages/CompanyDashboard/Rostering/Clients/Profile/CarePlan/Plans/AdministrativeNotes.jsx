...
import AdministrativeNotesDetails from "./PlansDetails/AdministrativeNotesDetails";
import {
  createClientTask,
  fetchClientTaskByClientAndRelatedTable,
} from "../../../../config/apiConfig";

const AdministrativeNotes = ({ carePlanSection, clientData, carePlanId }) => {
  ...
  const relatedTable = "LegalRequirement"; // As specified
    ...
    <div className="DDD-PPLso-Sec">
      <div className="DDD-PPLso-Sec-Main">
        <div className="DDD-PPLso-1">
          ...
          <AdministrativeNotesDetails carePlanSection={carePlanSection} />
        </div>
