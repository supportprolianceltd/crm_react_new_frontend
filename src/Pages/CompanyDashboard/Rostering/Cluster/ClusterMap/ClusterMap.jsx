...
const clients = [
  // London Cluster
  {
    ...
    fullAddress: "Flat 1, 123 Baker Street, London W1U 6EQ",
  },
  {
    id: 2,
    name: "Bob",
    position: [51.5115, -0.116],
  ...
  },
  {
    id: 3,
    name: "Charlie",
    position: [51.509, -0.142],
    status: "Inactive",
    location: "South Bank",
    fullAddress: "1 Waterloo Road, South Bank, London SE1 8SW",
  },
  {
    id: 4,
    name: "Diana",
    position: [51.503, -0.113],
    status: "Active",
    location: "Shoreditch",
    fullAddress: "123 City Road, Shoreditch, London EC1V 1AF",
  },
  {
    id: 5,
    name: "Ethan",
    position: [51.515, -0.092],
    status: "Inactive",
    location: "Hackney",
    fullAddress: "1 Mare Street, Hackney, London E8 1AA",
  },
  ...
  // Manchester Cluster
  {
    ...
    fullAddress: "1 Deansgate, Manchester M3 2BQ",
  },
  {
    id: 7,
    name: "George",
    position: [53.469, -2.238],
    status: "Temporarily Inactive",
    location: "Salford",
    fullAddress: "1 Abram Street, Salford M7 1AB",
  },
  {
    id: 8,
    name: "Hannah",
    position: [53.485, -2.231],
    status: "Inactive",
    location: "Ancoats",
    fullAddress: "1 Great Ancoats Street, Manchester M4 7BT",
  },
  {
    id: 9,
    name: "Ian",
    position: [53.476, -2.252],
    status: "Active",
    location: "Hulme",
    fullAddress: "1 Trinity Way, Hulme, Manchester M15 6FD",
  },
  {
    id: 10,
    name: "Julia",
    position: [53.466, -2.214],
    status: "Active",
    location: "Trafford",
    fullAddress: "Trafford House, Chester Road, Stretford, Manchester M32 0RS",
  },
  ...
  // Birmingham Cluster
  {
    ...
    fullAddress: "1 New Street, Birmingham B2 4AS",
  },
  {
    id: 12,
    name: "Laura",
    position: [52.479, -1.902],
    status: "Temporarily Inactive",
    location: "Digbeth",
    fullAddress: "1 Digbeth High Street, Birmingham B5 6DY",
  },
  {
    id: 13,
    name: "Michael",
    position: [52.495, -1.883],
    status: "Active",
    location: "Aston",
    fullAddress: "1 Ettington Road, Aston, Birmingham B6 6ES",
  },
  {
    id: 14,
    name: "Nina",
    position: [52.462, -1.874],
    status: "Inactive",
    location: "Bournville",
    fullAddress: "1 Bournville Lane, Bournville, Birmingham B30 1QX",
  },
  ...
  // Liverpool Cluster
  {
    ...
    fullAddress: "1 Castle Street, Liverpool L2 4TA",
  },
  {
    id: 16,
    name: "Paul",
    position: [53.416, -2.982],
    status: "Active",
    location: "Bootle",
    fullAddress: "1 Stanley Road, Bootle L20 3DY",
  },
  {
    id: 17,
    name: "Quinn",
    position: [53.392, -3.002],
    status: "Inactive",
    location: "Speke",
    fullAddress: "31 Tarbock Road, Speke, Liverpool L24 0SN",
  },
  {
    id: 18,
    name: "Rachel",
    position: [53.378, -2.977],
    status: "Active",
    location: "Crosby",
    fullAddress: "1 Liverpool Road, Crosby, Liverpool L23 2SR",
  },
  ...
  // Bristol Cluster
  {
    ...
    fullAddress: "42 Triangle West, Bristol BS8 1ES",
  },
  {
    id: 20,
    name: "Tina",
    position: [51.449, -2.592],
    status: "Active",
    location: "Clifton",
    fullAddress: "1 Clifton Down, Bristol BS8 4AF",
  },
  {
    id: 21,
    name: "Uma",
    position: [51.459, -2.572],
    status: "Temporarily Inactive",
    location: "Redfield",
    fullAddress: "1 Verrier Road, Redfield, Bristol BS5 7NP",
  },
  {
    id: 22,
    name: "Victor",
    position: [51.467, -2.601],
    status: "Inactive",
    location: "Filton",
    fullAddress: "1 Gloucester Road North, Filton, Bristol BS34 7BQ",
  },
  {
    id: 23,
    name: "Wendy",
    position: [51.441, -2.612],
    status: "Active",
    location: "Bedminster",
    fullAddress: "3 Princess Street, Bedminster, Bristol BS3 4AG",
  },
  {
    id: 24,
    name: "Xavier",
    position: [51.425, -2.583],
    status: "Inactive",
    location: "Brislington",
    fullAddress: "1 Bath Road, Brislington, Bristol BS4 5NL",
  },
];
...
const calculateClusterCentroid = (memberIds) => {
  ...
  const avgLat =
    members.reduce((sum, c) => sum + c.position[0], 0) / members.length;
  const avgLng =
    members.reduce((sum, c) => sum + c.position[1], 0) / members.length;
...
function ClusterSummary({ clusters, show }) {
  ...
  const toggleCluster = (clusterName) => {
    if (expandedClusters.includes(clusterName)) {
      setExpandedClusters(
        expandedClusters.filter((name) => name !== clusterName)
      );
    } else {
...
function ClusterMarker({ cluster, zoomLevel }) {
  ...
  return (
    <Marker
      ...
      icon={
        zoomLevel >= 8
          ? createClusterLabelIcon(cluster.clusterLabel, cluster.color)
          : createClusterDotIcon(cluster.color)
      }
      zIndexOffset={1000}
...
export default function ClientEmployeeMap({
  ...
  // Zoom to selected cluster when it changes
  useEffect(() => {
    if (selectedCluster && mapRef.current) {
      const center = [selectedCluster.latitude, selectedCluster.longitude];
      ...
      <MapContainer
        center={
          clusterData.length > 0
            ? [clusterData[0].latitude, clusterData[0].longitude]
            : [6.5, 3.4]
        }
          ...
          return (
            <Marker key={client.id} position={client.position} icon={icon}>
              <Popup>
                ...
                <div>
                  Status: <em>{client.status}</em>
                </div>
                <div>Cluster: {cluster ? cluster.name : "None"}</div>
                <div>
                  Location: <strong>{client.fullAddress}</strong>
                </div>
              </Popup>
            </Marker>
          );
          ...
          return (
            <Marker
              ...
              icon={L.divIcon({
                ...
                html: `
            <div style="
              background-color: ${isSelected ? "#FF6B35" : "#7226FF"};
              color: white;
              padding: ${isSelected ? "10px 14px" : "8px 12px"};
              border-radius: 20px;
              font-weight: bold;
            ...
            ">
              ...
              }; opacity: 0.9; margin-bottom: 2px;">${cluster.name}</div>
              <div style="font-size: ${
                isSelected ? "13px" : "12px"
              }; font-weight: bold;">${cluster.postcode}</div>
            </div>
          `,
                iconSize: null,
                iconAnchor: [0, 0],
            ...
            >
              <Popup>
                <div style={{ minWidth: "200px" }}>
                  <h4 style={{ margin: "0 0 8px 0", color: "#7226FF" }}>
                    {cluster.name}
                  </h4>
                  ...
                  <div style={{ marginBottom: "4px" }}>
                    ...
                    {(cluster.radiusMeters / 1000).toFixed(1)} km
                  </div>
                  {cluster.description && (
