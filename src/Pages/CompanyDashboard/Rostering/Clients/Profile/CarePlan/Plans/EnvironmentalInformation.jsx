...
import EnvironmentalInformationDetails from "./PlansDetails/EnvironmentalInformationDetails";
import {
  createClientTask,
  fetchClientTaskByClientAndRelatedTable,
} from "../../../../config/apiConfig";

const EnvironmentalInformation = ({
  carePlanSection,
  clientData,
  carePlanId,
}) => {
  ...
  const relatedTable = "PsychologicalInformation"; // As specified
    ...
    <div className="DDD-PPLso-Sec">
      <div className="DDD-PPLso-Sec-Main">
        <div className="DDD-PPLso-1">
          ...
          <EnvironmentalInformationDetails carePlanSection={carePlanSection} />
        </div>
